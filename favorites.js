import"./assets/header-Ddvfl8jP.js";const d="favorite-recipes";function u(){try{const t=localStorage.getItem(d);return t?JSON.parse(t):[]}catch(t){return console.error("Storage parse error:",t),[]}}const a=document.querySelector(".js-favorites-list"),s=document.querySelector(".js-favorites-categories"),m=document.querySelector(".js-favorites-empty");let r=[],n="All";document.addEventListener("DOMContentLoaded",g);function g(){if(r=u(),!r.length){f();return}o(),i(r)}function f(){m.classList.remove("is-hidden"),a.classList.add("is-hidden"),s.classList.add("is-hidden")}function i(t){a.innerHTML=t.map(p).join("")}function p(t){return`
